...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'api_django.serializers.CurrentUserSerializer'
}
...
ALLOWED_HOSTS = ['8000-alayousef-apidjango-klfjj19mi6z.ws-eu104.gitpod.io', 'apidjango-a1b0ccf0d7a8.herokuapp.com/']
